...
|---|---|---|
| Paper | [arXiv:2405.14697](https://arxiv.org/abs/2405.14697) | *Quantum amplitude estimation beyond power-of-two schedules* (arXiv, Sept 2026) |
...
| Where | this folder: `csae.py`, `csAE_example.ipynb`, `plots.ipynb` | [`research/`](research/) with its own [README](research/README.md); core module `research/mlqae.py` |
| Live demo | — | [`docs/index.html`](docs/index.html) (open in a browser, or via GitHub Pages) |

The rest of this file documents csAE. For the ladder method, start at [`research/README.md`](research/README.md).
